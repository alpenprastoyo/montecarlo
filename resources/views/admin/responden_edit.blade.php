...
@section('content')
  ...
  <div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Responden</h1>
    </div>
    ...
    <form action="{{ route('admin.responden.update')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <input type="text" hidden value="{{ $responden->id }}" name="id">
                ...
                <div class="row">
                    <div class="col-8">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ $responden->email }}" placeholder="Masukkan username." type="text" title="Minimal 6 karakter dan dapat disertai dengan kombinasi huruf besar (kapital), huruf kecil, dan angka." class="form-control border-bottom border-success-subtle" id="username" name="email"  autocomplete="off" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <label for="" class="col-sm-0.5 col-form-label text-gray-900">:</label>
                            <div class="col-sm-7">
                                <input value="{{ $responden->name }}" placeholder="Masukkan nama responden." type="text" class="form-control border-bottom border-success-subtle" id="nama" name="name" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <label for="" class="col-sm-0.5 col-form-label text-gray-900">:</label>
                            <div class="col-sm-3">
                                <input value="{{ $responden->usia }}" placeholder="Masukkan angka." type="text" onkeypress="return hanyaAngka(event)" class="form-control border-bottom border-success-subtle" id="usia" name="usia" maxlength="2" autocomplete="off" required>
                            </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <label for="" class="col-sm-0.5 col-form-label text-gray-900">:</label>
                            <div class="col-sm-7">
                                <input value="{{ $responden->jabatan }}" placeholder="Masukkan jabatan." type="text" class="form-control border-bottom border-success-subtle" id="jabatan" name="jabatan" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <label for="" class="col-sm-0.5 col-form-label text-gray-900">:</label>
                            <div class="col-sm-3">
                                <input value="{{ $responden->pengalaman_kerja }}" placeholder="Masukkan angka." type="text" onkeypress="return hanyaAngka(event)" class="form-control border-bottom border-success-subtle" id="pengalaman_kerja" name="pengalaman_kerja" maxlength="2" autocomplete="off" required>
                            </div>
                            <label for="tahun" class="col-sm-3 col-form-label text-gray-900">Tahun</label>
                        </div>
                        <div class="mb-3 row">
